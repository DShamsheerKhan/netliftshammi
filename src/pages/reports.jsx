...
const Reports = () => {
  ...
  useEffect(() => {
    const fetchPageData = async () => {
      ...
      try {
        const response = await fetch(`https://reports.itqancapital.com/api/pages/?filters[custom_slug][$eq]=reports&populate[sections][populate][section_content][populate]=*&locale=${locale}`, {
          headers: {

...
const CompaniesLogin = () => {
  ...
  const fetchGeneralInformation = async data => {
    ...
    try {
      const response = await axios.post(
        "https://app.netlify.com/projects/dainty-brigadeiros-5e00ce/deploys/api/general-informations",
        { data: formattedData },
        {
          headers: {
            "Content-Type": "application/json",
            Authorization:
              "Bearer ", // Use your actual token here
          },
        }
      )
  ...
  const fetchAuthorizedPersons = async data => {
    ...
    try {
      const response = await axios.post(
        "https://app.netlify.com/projects/dainty-brigadeiros-5e00ce/deploys/api/authorized-people",
        { data: formattedData },
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const handleSubmit = async (
    ...
    console.log("🔍 handleSubmit called - Corporate form")
    ...
    try {
      console.log("🚀 Starting multi-step form submission process")
      
      // Step 1: Send general information and retrieve their IDs
      console.log("📋 Step 1: Processing general information", values.generalInformation)
      ...
      console.log("✅ General information processed:", generalInfosData)
      ...
      console.log("👥 Step 2: Processing authorized persons", values.authorizedPersons)
      ...
      console.log("✅ Authorized persons processed:", authorizedPeopleData)
      ...
      console.log("📦 Step 3: Creating FormData for final submission")
      ...
      console.log("🚀 Starting final API request to:", "https://app.netlify.com/projects/dainty-brigadeiros-5e00ce/deploys/api/companies-logins?populate=*")
      const response = await axios.post(
        "https://app.netlify.com/projects/dainty-brigadeiros-5e00ce/deploys/api/companies-logins?populate=*",
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data", // Use multipart/form-data for file uploads
            Authorization:
              "Bearer ", // Replace with your actual token
          },
        }
      )
      console.log("✅ Final API response received:", response.status, response.statusText)

      // Check if the response is successful
      if (response.status === 200) {
        console.log("🎉 Corporate form submission successful!")
      ...
      console.error("❌ Error during corporate form submission:")
      console.error("Error details:", error.response ? error.response.data : error.message)
      console.error("Full error object:", error)
      setFormError(true) // Manage error state
    } finally {
      console.log("🏁 Corporate form submission process completed, setting submitting to false")
              ...
              return (
                <Form className="individuals-login-field">
                                ...
                                >
                                  ...
                                  <div className="individuals-single-field">
                                    ...
                                    >
                                      ...
                                      <option value="Family ID / بطاقة العائلة">
                                      ...
                                      <option value="Residence / الإقامة">
                      ...
                      <div className="individuals-sec-field">
                        ...
                        <div className="individuals-single-field">
                          ...
                          >
                            ...
                            <option value="High Risk / مخاطرة عالية">
                              <FormattedMessage id="riskAppetite.highRiskOption" />
                            </option>
                            <option value="Moderate Risk / مخاطرة متوسطة">
                              <FormattedMessage id="riskAppetite.moderateRiskOption" />
                            </option>
                            <option value="Low Risk / مخاطرة منخفضة">
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      console.log("🖱️ Submit button clicked - Corporate form")

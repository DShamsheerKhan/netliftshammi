...
const JoinUs = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `https://reports.itqancapital.com/api/pages/?filters[custom_slug][$eq]=join-us&populate[sections][populate][section_content][populate][subtitle][populate]=*&locale=${locale}&populate=image&populate=*&populate[sections][populate][section_content][populate][image][populate]=*`,
          {
            headers: {
              Authorization:
  ...
  const handleSubmit = event => {
    ...
    axios
      .post(
        "https://reports.itqancapital.com/api/join-uses?populate=*",
        payload,
        {
          headers: {
  ...
  const availableJobs = contactData.sections.data.find(
    section => section.attributes.section_title === "available jobs"
          ...
          <div className="Contact-footer-container Contact-career-container">
            ...
            <div className="available-jobs-section">
              ...
              <div className="available-jobs-container">
                ...
                >
                  <h4><FormattedMessage id="other_job_option" defaultMessage="Other" /></h4>
                  <p><FormattedMessage id="other_job_description" defaultMessage="Apply for a position not listed here" /></p>
                </div>
              </div>
            </div>

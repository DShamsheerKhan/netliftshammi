...
const Reports = () => {
  ...
  useEffect(() => {
    const fetchPageData = async () => {
      ...
      try {
        const response = await fetch(`https://app.netlify.com/projects/dainty-brigadeiros-5e00ce/deploys/api/pages/?filters[custom_slug][$eq]=reports&populate[sections][populate][section_content][populate]=*&locale=${locale}`, {
          headers: {

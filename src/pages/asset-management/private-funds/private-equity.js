...
const PrivateEquity = () => {
  ...
  const privateSection = pageData?.sections?.data.find(section => 
    section.attributes?.section_title === "الأسهم الخاصة" ||
    section.attributes?.section_title === "Private Funds"
  );
  const privateSectionHeader = pageData?.sections?.data.find(section => 
    section.attributes?.section_title === "Private Funds header" ||
    section.attributes?.section_title === "Private Funds header"
  );
  console.log("privateSectionHeader",privateSectionHeader)

...
const VentureCapital = () => {
  ...
  const privateSection = pageData?.sections?.data.find(section => 
    section.attributes?.section_title === "رأس المال الاستثماري" ||
    section.attributes?.section_title === "Venture Capital"
  );
  const privateSectionHeader = pageData?.sections?.data.find(section => 
    section.attributes?.section_title === "Venture Capital Header" ||
    section.attributes?.section_title === "Venture Capital header"
  );

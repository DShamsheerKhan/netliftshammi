...
const Layout = ({ children, overPadding }) => {
    ...
    const fetchData = async () => {
      try {
        ...
        const newsletterResponse = await fetch(
          `https://app.netlify.com/projects/dainty-brigadeiros-5e00ce/deploys/api/sections?filters[custom_slug][$eq]=Newsletter&locale=${locale}&populate[section_content][populate][title]=*&populate[section_content][populate][subtitle]=*`,
          {
            headers: {
              Authorization:
        ...
        const addressResponse = await fetch(
          `https://app.netlify.com/projects/dainty-brigadeiros-5e00ce/deploys/api/sections?filters[custom_slug][$eq]=address_footer&locale=${locale}&populate[section_content][populate][title]=*&populate[section_content][populate][subtitle]=*`,
          {
            headers: {
              Authorization:
                "Bearer ",
  ...
  const handleSubmit = async e => {
    ...
    const response = await fetch(
      "https://app.netlify.com/projects/dainty-brigadeiros-5e00ce/deploys/api/newsletter-emails",
      {
        method: "POST",
        headers: {

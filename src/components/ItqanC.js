...
const ItqanC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const baseUrl = `https://app.netlify.com/projects/dainty-brigadeiros-5e00ce/deploys/api/pages/?filters[custom_slug][$eq]=home_page&populate[sections][populate][section_content][populate][points][populate]=*&locale=${locale}&populate=title_icon`;
